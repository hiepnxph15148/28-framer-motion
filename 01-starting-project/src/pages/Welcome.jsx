...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 300, 500], [0, 50, 100]);
  const yHero = useTransform(scrollY, [0, 200], [0, -50]);
  const scaleText = useTransform(scrollY, [0, 300, 500], [1, 1, 1.5]);
  const yText = useTransform(scrollY, [0, 300, 500], [0, 50, 100]);
